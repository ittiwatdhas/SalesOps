...
export default {
    ...
    settingReturnCustomerLocation(value) {
     
        var formData = new FormData();
        formData.append("select_plan", value.select_plan);
        formData.append("province_code", value.province_code);
        formData.append("salesman_code", value.salesman_code);
        ...
        return Vue.http.post(Vue.config['url'] + "/setting-return-customer-location", formData, {
            headers: {
