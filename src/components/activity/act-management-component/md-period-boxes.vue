<template>
  <div style="display : flex" class="md-period-box" @mouseleave="mouseLeave">
    ...
    <div style="margin-left:10px; margin-right: 0px; height:45px;width:70%;">
      <md-card style="background:unset;box-shadow:unset;overflow:hidden">
        <md-card-content style="padding:0px;">
          <div
            class="floating-box-big"
            style="display:-webkit-box;width:100%;overflow: hidden;"
          >
            <div style="width:42%; padding-left: 15px;">
              <md-auto-search-box
            ...
            <div  style="display: flex;justify-content: flex-end;width:15%;height:100%;padding-top:7px">
              <md-button
                :class="'-orange'"
                style="min-width:60px;margin:unset;border-radius:3px;font-size: 12px;"
