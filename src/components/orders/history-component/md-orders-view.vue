<template>
  <div>
    ...
    <div class="md-dialog-content">
      ...
      >
            ...
            <div style="display: flex;width:100%">
              ...
              <div style="margin-left:15px;width:74%">
                ...
                <div style="display: flex;">
                  ...
                  >
                    <div style="width:100%;cursor:pointer" @click="addTakeNote">
              ...
              <md-layout class="md-body">
                ...
                <div style="display:flex;width:100%;margin-top:17px">
                  ...
                  <div style="width:60%;padding-right:20px">
                    ...
                    <div class="title-ipt-roboto">{{data.head.term}}</div>
                  </div>
        ...
        >
          <div
            class="head-table"
            v-sticky="{ zIndex: 20, stickyTop: 60 }"
    ...
    <md-dialog ref="clearData-dialog-his">
...
export default {
  ...
  computed: {
    commentList() {
      return this.$store.getters["history/commentList"];
    },
    dataList() {
    ...
    payByCash() {
      return this.$store.getters["history/paybycash_list"];
    },
    totalItems() {
      return this.$store.getters["history/totalItems"];
    },
    disableFrom() {
      return this.$store.getters["history/disableFrom"];
    }
  },
  methods: {
    renderPrice(data) {
    ...
    addTakeNote() {
      ...
      this.leftBtn = "CLOSE";
      this.rightBtn = "SAVE";
      this.$refs["clearData-dialog-his"].open();
    },
    showBath(row, mode) {
