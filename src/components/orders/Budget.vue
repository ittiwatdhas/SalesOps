                  ...
                  >
                    ...
                    <div style="padding-left: 30px">
                      ...
                      >
                        ...
                        >
                          <md-input
                            style="color: rgb(65, 65, 65); font-size: 16px"
              ...
              <md-card class="tap-table">
                <md-layout md-flex="100" style="flex: unset">
                  ...
                  >
                    ...
                    <div style="padding-left: 5px; width: 32%" class="pt-5">
                      <div
                      id="dropdown-box-w3"
                        class="md-dropdown-box"
                        @mouseleave="mouseLeaveDropdow"
                    ...
                    <div style="padding-left: 5px; width: 26%" class="pt-5">
                      <div
                      id="dropdown-box-w4"
                        class="md-dropdown-box"
                        @mouseleave="mouseLeaveDropdow_corp"
                      >
                        <md-input-container
                          md-theme
                          class="dropdown-box"
                          @click.native="getWidth4($event)"
                        >
                          <md-input
                            @keypress.native="showAutocom_corp = true"
                            @focus="openAutoCom_corp"
                          ...
                          <md-button
                            class="md-icon-button"
                            @click.native="showAutocom_corp = true"
                          >
                            <md-icon style="padding-top: 1px"
                              >arrow_drop_down</md-icon
                            >
                        ...
                        <md-card
                          class="text-autocomplete"
                          v-if="showAutocom_corp"
                          :style="{ width: widthTag4 + 'px' }"
                        >
                          <div
                            class="no-data-promo"
                            v-if="dataCorporate.length == 0"
                          >
                            <span>No data Corporate</span>
                          </div>
                          <ul class="md-list" v-else>
                            <li
                              class="md-list-item"
                              v-for="(item, index) in dataCorporate"
                              :key="item.id"
                            >
                              <div
                                class="md-list-item-row"
                  ...
                  <md-layout md-flex="40" md-align="end">
                    <div style="width: 50%" class="pt-5">
                      <md-search-box
                        ...
                        :data="[]"
                        :value="keywordPurMT"
                        @filter="valueKeywordPurMT"
                        @clear="clearKeywordPurMT"
                      ></md-search-box>
                      <!-- @filter="onSearchListMT" -->
                      <!-- @clear="keywordPurCLR" -->
                      <!-- @filter="keywordPurFil" -->
                    </div>
                    <div
                    ...
                    >
                      <md-button
                        ...
                        style="
                          ...
                          width: 100%;
                        "
                        @click="onSearchListMT"
                      >
                        <md-icon style="padding-left: 3px">search</md-icon>
                      </md-button>
                    </div>
                  </md-layout>
                </md-layout>
                ...
                >
                  ...
                  <div
                    ...
                    style="width: 10%; padding-right: 10px"
                  >
                    {{ formatNumber(total_amount_mt) }}
                  </div>
                  <div
                    class="number pt-2 text-right"
                    style="width: 10%; padding-right: 10px"
                  >
                    {{ formatNumber(total_netamount_mt) }}
                  </div>
                  <div
                    class="number pt-2 text-right"
                    style="width: 10%; padding-right: 10px"
                  >
                    {{ formatNumber(total_budget_mt) }}
                  </div>
                  <div class="text-left" style="width: 3%"></div>
                </div>

                <!-- HEAD TABLE -->
                <div :class="'head-table'" id="moreClick" style="padding-left: 10px;">
                  <div class="text-left" style="width: 9%">PO NO.</div>
                  <div class="text-left" style="width: 8%">PO. Date</div>
                  <!-- <div class="text-left" style="width: 8%">Approve Date</div> -->
                  <div class="text-left" style="width: 8%">Delivery Date</div>
                  <div class="text-left" style="width: 28%">Customer</div>
                  <div class="text-left" style="width: 14%">Salesman</div>
                  <div class="text-right" style="width: 10%">Total Amount</div>
                  <div class="text-right" style="width: 10%">Net Amount</div>
                  <div class="text-right" style="width: 8%">Used Budget</div>
                  <!-- <div class="text-center" style="width: 5%">Note</div> -->
                  <div class="text-left" style="width: 5%"></div>
                </div>
                ...
                >
                  <div
                    v-for="items in tablePurchaseMT"
                    :key="items.po_no"
                    class="content-table"
                    style="font-family: roboto; padding-top: 7px"
                  >
                    ...
                    <div class="number pt-2" style="width: 8%">
                      {{ diaplayDate(items.po_date) }}
                    </div>
                    <!-- <div class="number pt-2" style="width: 8%">
                      {{ showTime(items.apv_apvdate) }}
                    </div> -->
                    <div class="number pt-2" style="width: 8%">
                      {{ diaplayDate(items.delivery_date) }}
                    </div>
                    <div
                      class="descript pt-2"
                      style="
  ...
  watch: {
    ...
    loadDataMT() {
      if (this.loadDataMT === true) {
        this.onSearchListMT();
        this.$store.commit("budget/setLoadDataMT", false);
      }
    },
  },
  methods: {
    ...
    getWidth(e) {
      console.log(document.getElementById('dropdown-box-w').offsetWidth)
      this.widthTag =  document.getElementById('dropdown-box-w').offsetWidth
    },
    getWidth2(e) {
      // this.widthTag = e.path[2].offsetWidth;
      this.widthTag2 =  document.getElementById('dropdown-box-w2').offsetWidth

    },
    getWidth3(e) {
      this.widthTag3 =  document.getElementById('dropdown-box-w3').offsetWidth

    },
    getWidth4(e) {
      this.widthTag4 =  document.getElementById('dropdown-box-w4').offsetWidth
    },
