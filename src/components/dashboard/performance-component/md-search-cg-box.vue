<template>
  <div class="md-search-box" v-click-outside="mouseLeave">
    ...
    <md-card
      ...
      v-if="showAutocom"
      :style="{'width' : widthTag +'px' , 'top' : top +'px' , 'max-height' : maxHeight + 'px !important'}"
    >
...
export default {
  ...
  methods: {
    ...
    openAutoCom(e) {
      let total = window.screen.height - e.screenY;
      let rs = total / 1.8;
      this.maxHeight = rs > 300 ? 300 : rs;
      this.top = e.pageY - e.offsetY + 38;
