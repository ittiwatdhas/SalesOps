  ...
  <div id="paymentreportPage">
    ...
    <div
      ...
      style="z-index: 2;
            ...
            height: 100%;"
    ></div>
    <div style="padding-right:30px;width:30%">
    <div class="main-title" style="margin-bottom:20px;width:100%">INCENTIVE</div>
    </div>
    <div
    ...
    >
      <div style="width:100%;display:flex;">
        ...
        <div style="width:55%;text-align:left;padding-left:5%" class="no-under-line-dp">
          <div v-if="department != 'SM'" class="text-1">Sales Team</div>
          <div v-if="department == 'SM'" class="text-1">Salesman</div>
          <md-input-container v-if="department != 'SM'"
            style="margin:unset;min-height:30px;padding:0px;max-width:610px">
            <md-select multiple v-model="team_select" v-if="department != 'SM'">
              <md-subheader
          ...
          <div  v-if="department == 'SM'" style="width:55%;padding-top:9px;text-align:left;font-size:17px" class="no-under-line-dp">
              <div v-if="department == 'SM'"  >{{txt_emp_id}} {{txt_username}}</div>
          </div>
        </div>
        <div style="width:10%;padding-top: 20px;text-align:left;padding-left:10%" class="no-under-line-dp">
          <div v-if="datasList.flow_state == 'pass'" class="text-1" style="color:#66BB6A"><b>APPROVED</b></div>
          <div v-if="datasList.flow_state == 'pending'" class="text-1" style="color:#fd7f00"><b>PENDING</b></div>
        </div>
      </div>
    </div>
    <div
    ...
    >
      ...
      >
        ...
        <div style="width:7%;text-align:left">Actual Sales</div>
        <div style="width:10%;text-align:left"></div>
        <div style="width:9%;text-align:left">Target</div>
        <div style="width:9%;text-align:left"></div>
        ...
        <div style="width:8%;text-align:left"></div>
        <div style="width:8%;text-align:left">
          Year on Year
          <br />
          (&nbsp;{{ yearLable.year_last_name }}&nbsp;)
          ...
          <div style="width:100%;font-family:roboto">
            <!-- <div style="display:flex;padding:5px 0px 8px 10px;">
              ...
              >
                ...
                <!-- format MNG -->
                <div style="width:100%;margin-top:5px;" class="row-2" v-if="department != 'SM'">
                ...
                <!-- format SM -->
                <div style="width:100%;margin-top:5px;" class="row-2" v-if="department == 'SM'">
                  <div style="width:3%;padding-top:3px"></div>
                  <!-- <div
                    @click="hideDetail(index2)"
                    style="width:16%;text-align:left;font-family:kanit;padding-top:3px;cursor:pointer"
                  >
                  ...
                  <div style="width:8%;text-align:left;padding-top:3px">
                    <b>
                      {{ subPoint(row2.paid, 'front') }}
                      <span style="font-size:10px;">{{
                        subPoint(row2.paid, 'back')
                ...
                >
                <!-- row2.detail_sm.paid_detail_data.length -->
                  <div 
                    class="row-2"
                    v-if="
                      row2.show_detail == 'paid' || row2.show_detail == 'actual'
...
<!-- /////////////////////////////////////////////////////////////////SM/////////////////////////////////////////////////////////////////// -->
                ...
                >
                  <div style="display:flex;background:#F7F7F7;padding:5px;">
                    ...
                    <div style="width:18%;text-align:left;padding-left:5px">
                      <b>
                        {{ subPoint(row2.detail_sm.paid_detail_total, 'front') }}
                        <span style="font-size:12px">{{
                          subPoint(row2.detail_sm.paid_detail_total, 'back')
                        }}</span>
                      </b>
                    </div>
                    <div style="width:5%;"></div>
                ...
                <div
                  v-for="(row3, index3) in row2.detail_sm.paid_detail_data"
                ...
                <!-- row2.detail_sm.paid_detail_data.length -->
                  <div 
                    ...
                    :style="{
                      width: '100%',
                      'margin-bottom':
                        index3 == row2.detail_sm.paid_detail_data.length - 1 ? '20px' : '0px',
                      display: 'flex'
                    }"
                  ...
                  >
                    ...
                    <div
                      style="width:25%; display: flex;"
                    > 
                      <div style="width:55%;text-align:left;padding-top:2px;font-family:kanit">{{ row3.title }}
                      </div >
                      <div v-if="row3.type == 'count_items'"
                        style="text-align:left;padding-left: 10px;"
                        @click="showDetaillSm('paid',index2, index3, 'info')"
                      >
                        <md-icon style="color:#A8A8A8;cursor:pointer">info</md-icon>
                      </div>
                      <div v-if="row3.type == 'count_items'"
                    ...
                    <div v-if="row3.type != 'invoices' && row3.type != 'orders'"
                      style="width:5%;text-align:left;padding-top:3px"
                      @click="showDetaillSm('paid',index2, index3)"
                    >
                    <!-- {{row3.type}} -->
                      <md-icon style="color:#A8A8A8;cursor:pointer"
                        >keyboard_arrow_right</md-icon
              ...
              <!-- Actual -->
                ...
                >
                  <div style="display:flex;background:#F7F7F7;padding:5px;">
                    ...
                    <div style="width:18%;text-align:left;padding-left:5px">
                      <b>
                        {{ subPoint(row2.detail_sm.actual_sales_detail_total, 'front') }}
                        <span style="font-size:12px">{{
                          subPoint(row2.detail_sm.actual_sales_detail_total, 'back')
                        }}</span>
                      </b>
                    </div>
                    <div style="width:5%;"></div>
                ...
                <div
                  v-for="(row3, index3) in row2.detail_sm.actual_sales_detail_data"
                  :key="'con4-' + index2 + '-' + index2 + '-' + index3"
                  :style="{
                    width: '100%',
                    'margin-top': '2px',
                    padding: '0px 43px 0px 23px',
                ...
                <!-- row2.detail_sm.paid_detail_data.length -->
                  <div 
                    ...
                    :style="{
                      width: '100%',
                      'margin-bottom':
                        index3 == row2.detail_sm.actual_sales_detail_data.length - 1 ? '20px' : '0px',
                      display: 'flex'
                    }"
                  ...
                  >
                    ...
                    > 
                      ...
                      <div v-if="row3.type == 'count_items'"
                        style="text-align:left;padding-left: 10px;"
                        @click="showDetaillSm('actual',index2, index3)"
                      >
                        <md-icon style="color:#A8A8A8;cursor:pointer">info</md-icon>
                      </div>
                      <div v-if="row3.type == 'count_items'"
...
export default {
  ...
  computed: {
    loadingMain() {
      return this.$store.getters["incentive_dashboard/loadingMain"];
    },
    datasList() {
      return this.$store.getters["incentive_dashboard/datasList"];
    },
    dataDefault() {
      return this.$store.getters["incentive_dashboard/dataDefault"];
    },

    teamListSelect() {
      this.team_select = this.$store.getters["incentive_dashboard/teamListSelect"];
      return this.$store.getters["incentive_dashboard/teamListSelect"];
    },
    detailList() {
      return this.$store.getters["incentive_dashboard/detailList"];
    },
    yearLable () {
      return this.$store.getters["incentive_dashboard/detailList"].total_year
    },
    dataState () {
      return this.$store.getters["incentive_dashboard/datasList"].state;
    }
  },
  methods: {
    init () {

      this.$store.dispatch("incentive_dashboard/getDataDefault",'dashboard_incentive');
    },
    chooseSelect (type){
      let rs = this.dataDefault
      rs.team_select = this.team_select
      rs.view = 'dashboard_incentive'
      
      this.$store.commit('incentive_dashboard/setLoadingMain', true)
      ...
      //   console.log(datasList.team_arr[rs.year])
        ...
        if(datasList.cycles.length >0){
          this.dataDefault.cycle = datasList.cycles[datasList.cycles.length-1].code
      ...
      // this.$store.commit('incentive_dashboard/setDatasList', datasList);
      this.$store.commit('incentive_dashboard/setTeamListSelect', team_select)
      rs.team_select = this.team_select

      this.$store.commit('incentive_dashboard/setDataDefault',rs)
      service
        .getPaymentReportDetail(rs)
        .then(response => {
          datasList.status_show = response.status_show,
          datasList.state = response.state,
          // console.log(response.flow_state)
          datasList.flow_state = response.flow_state,
          this.$store.commit('incentive_dashboard/setDatasList', datasList);
          this.$store.commit('incentive_dashboard/setDetailList', response);
          this.$store.commit('incentive_dashboard/setLoadingMain', false)
        })
        .catch();
    },
    ...
    selecedTeam (val) {
      ...
      this.$store.commit('incentive_dashboard/setTeamListSelect', team_check)
    ...
    hideDetail (index) {
      ...
      this.$store.commit('incentive_dashboard/setDetailList', master)
    },
    sortCol (mode) {
      if (mode == 2) {
        this.col2 = !this.col2
    ...
    showDetaill (index2, index3, type = null) { 
      ...
      service
        ...
        .then(response => {
          if(obj.button_type === 'tactics2'){
            if(response.detail.length != 0){
            response.detail[0].item_cg.sort((a, b) => (a.code > b.code) ? 1 : -1)
          }
          }
          ...
          // }
          this.$store.commit('incentive_dashboard/setLoadingMain', false)
          this.$store.commit('incentive_dashboard/setShowBar', false)
        })
        .catch()
    },
    showDetaillSm (status, index2, index3, type = null) { 
      this.$store.commit('incentive_dashboard/setLoadingMain', true)
      let master = _.cloneDeep(this.detailList)
      // let mom = master.group[index]
      let sm = master.sales[index2]
      let detail = []
      if(status == 'paid'){
        detail = master.sales[index2].detail_sm.paid_detail_data[index3]
      }else{
        detail = master.sales[index2].detail_sm.actual_sales_detail_data[index3]
      }
      // console.log(detail)
      let emp_ids = Vue.localStorage.get('emp_id')
      if (!_.isUndefined(sm)) {
      ...
      var detail_type = []
      if(status == 'paid'){
        detail_type = (type !=  null)?detail.type+"_"+type : detail.type
      }else{
        detail_type = (type !=  null)?detail.type+"_"+type : detail.type
      }
    ...
    openDG (mode) {
      this.modeCF = mode
      if(mode == 'closing'){
        this.titleCF = 'Do you want to close all sales department cycle. '
        this.titleButton = 'OK'
  ...
  components: {
    ...
    'count-item-dialog': require('../planning/saleincentive-component/count-item-dialog'),
    'count-item-detail-dialog': require('../planning/saleincentive-component/count-item-detail-dialog'),
    'tactics1-dialog': require('../planning/saleincentive-component/tactics1-dialog'),
    'tactics2-dialog': require('../planning/saleincentive-component/tactics2-dialog'),
    'add-deduction-dialog': require('../dashboard/incentive-component/add-deduction-dialog'),
    'invoice-dialog': require('../dashboard/incentive-component/invoice-dialog'),
    "md-comment-dialog": require("../dashboard/incentive-component/md-comment-dialog")
