      ...
      <div class="body-cons">
        <div class="borders">
          ...
          <div style="width:100%;">
            ...
            >
              <div v-if="department != 'SM'" style="width:38%;text-align:left;">
                <b>TOPICS</b>
              </div>
              <div v-if="department != 'SM'" style="width:32%;text-align:left">
                <b>TYPE</b>
              </div>
              <div v-if="department != 'SM'" style="width:11%;text-align:left;padding-left:10px">
                <b>PAID</b>
              </div>
              <div v-if="department != 'SM'" style="width:29%;text-align:left">
                <b>COMMENT</b>
              </div>


              <!-- SM -->
              <div v-if="department == 'SM'" style="width:52%;text-align:left;">
                <b>TOPICS</b>
              </div>
              <div v-if="department == 'SM'" style="width:45%;text-align:left">
                <b>TYPE</b>
              </div>
              <div v-if="department == 'SM'" style="width:18%;text-align:left;padding-left:10px">
                <b>PAID</b>
              </div>
            ...
            >
              <div style="display:flex;width:100%;padding-left:35px" class="box-1-detail">
                <div style="width:45%;padding-right:30px;padding-left:25px;">
                  <md-input-container
                ...
                <div style="width:35%;text-align:center;padding-right:30px">
                  <md-input-container
                    style="margin:0px;min-height:30px;height:30px;padding-top:0px"
                  >
                    <md-select
                ...
                <div style="width:16%;text-align:center;display:flex">
                  ...
                  <div style="width:90%;padding-right:30px;padding-top:7px" class="hide-dis">{{line.paid}}
                    <!-- <mds-input
                      v-model="line.paid"
                      :id="'paid-'+indexs"
                      :table="'paid'"
                ...
                <div v-if="department != 'SM'"  style="width:25%;text-align:center" class="hide-dis"> 
                  <md-input-container
                ...
                <div v-if="department != 'SM'" style="width:10%;text-align:right;padding-right:5px">
                  <md-button
            ...
            <div v-if="department != 'SM'" style="width:100%;background:#EFEFEF;padding:10px;font-size:14px;display:flex">
              <div style="width:64%"></div>
              <div style="width:36%;padding-left:13px">
            ...
            <div v-if="department == 'SM'" style="width:100%;background:#EFEFEF;padding:10px;font-size:14px;display:flex">
              ...
              <div style="width:16%;padding-left:13px">
                <span v-if="datas.head.total >= 0">+</span>
                <span v-else-if="datas.head.total < 0">-</span>
                {{showTotal(datas.head.total)}}
              </div>
...
export default {
  ...
  //     this.$store.dispatch("payment/getDataDefault");
  // },
  created () {
