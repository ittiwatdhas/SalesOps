  ...
  export default {
    ...
    methods: {
      ...
      closeDatepicker(){
        ...
        this.$emit("savedatepicker" , false);
      },
...
<template>
    ...
    <div class="calendar-container" :style="{left: morePos.left + 'px', top: morePos.top + 'px'}">
      <div class="calendar" >
        <header :style="{ 'background-color': '#FD7F00' , 'color':'#fff' }" class="calendar-header">
            <span :class="{ 'calendar-faint': selecting === 'year' }"   @setShowDatePicker="setdete" 
