<template>
  <div class="md-dropdown-box" @mouseleave="mouseLeave">
    <md-input-container id="get_w" md-theme class="dropdown-box" @click.native="getWidth($event)">
...
export default {
  ...
  methods: {
    ...
    getWidth(e) {
      console.log(document.getElementById('get_w').offsetWidth)
