...
export default class HotelDatepicker {
    constructor(input, options) {
        ...
        // DOM input
        this.input = document.getElementById('startDatePickerID');
    ...
    createDatepickerDomString() {
        let startDummyText = this.lang('custom'),
            endDummyText = this.lang('custom');
        ...
        let html =
            '<div id="' + this.getClearButtonId() + '" class="datepicker__clear-button"></div>' +
        ...
        html +=
            '<div style="visibility: hidden;" id="dummyWrapper' + this.getDatepickerId() + '" class="datepicker__dummy-wrapper ' + (this.useDummyInputs == true ? ' ' : ' -is-hidden') + '">' +
    ...
    documentMouseOut(evt) {
        ...
        if (evt.target.tagName && evt.target.tagName.toLowerCase() === 'td') {
            ...
            // if( tooltipContainer.style.display != '' || tooltipContainer.style.display != null){
    ...
    dayClicked(day) {
        ...
        let rs  = '';
        if (this.start) {
            rs = this.getDateString(new Date(this.start));
        }
        if (this.end) {
            rs = this.getDateString(new Date(this.start)) + ' - ' + this.getDateString(new Date(this.end));
        }
            document.getElementById('startDatePickerID').value = rs;
    ...
    dayHovering(day) {
        ...
        if (tooltip) {
            ...
            const tooltipContainer = document.getElementById(this.getTooltipId());
        //    if(tooltipContainer.style.display != null){
        //         tooltipContainer.style.display = 'none';
        //    }
        }
    }
