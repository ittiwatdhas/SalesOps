<template>
<div id="comment" style="top:20%;left:18%;
    position: absolute;
    box-shadow: 0 1px 5px rgba(0,0,0,.2), 0 2px 2px rgba(0,0,0,.14), 0 3px 1px -2px rgba(0,0,0,.12);" >
    <div class="dialog  pv-0" style="width: 250px;">
        <md-list  class="-bg-gray-EF pt-0">
                <md-divider ></md-divider>
                <md-list-item class="headgray text-left mv-0 mh-0 pt-8 latoFont pl-0" style="padding-left: 15px;" @click="checkMonth">
                    <span class="pl-16 -font-16">Last Month</span>
                    <md-list-expand>
                   ...
                   <md-divider ></md-divider>
                    ...
                    <md-divider ></md-divider>
                    <div style="max-height: 250px; overflow: auto; overflow-x: hidden !important;">
                <div :class="getRowColor(row.status)" class="width-250" :key="row.id"  v-for="row in comments['thismonth']">
            ...
            <md-list-item class="-bg-gray-EF">
            <md-button class="md-raised -orange mr-5 button-comment ml-0"  @click="saveComment">
                    <label class="md-display -font-14 latoFont">Reply</label>
                </md-button>
                <md-button class="md-raised -gray-A8 button-comment mr-0" @click="closeComment">
  ...
  let arr_notifi = [{
   ...
   //     },
        ...
        methods : {
            ...
            saveComment(){
            // console.log(this.doc_comment.document_no);
                if(this.txtComment != ''){
                    const comment = {
                        ...
                        'emp_id_start':this.doc_comment.emp_id,
            ...
            getComment(){
                   // alert(this.document_no);
                    let doc_comment = this.doc_comment;
                    //    console.log(this.doc_comment) 
                    let self = this;
                    const docs_comment = {
