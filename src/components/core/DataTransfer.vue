        ...
        >
          ...
          >
           ...
           <md-icon style="margin:0;cursor: pointer;font-size:23px;color:#fff;">priority_high</md-icon>
             ...
             <md-tooltip  style="height: auto; white-space: normal; max-width:30%;"  md-delay="100" md-direction="top"> <span class="kanitFont">Log Sync </span></md-tooltip> 
              </div>
            </div>
          </div>
        </md-layout>
    ...
    >
      <md-dialog-title style="margin:0 0 5px 0;padding:0;background-color:#EFEFEF">
         <md-layout>
          ...
          >
            <div class="title" style="font-size:16px;color:#414141;opacity: 0.8;">Log Transfer Stock</div>
          </md-layout>
...
<div  style="padding-left:30px;">
    ...
    :style="{ 
       height: '75%', 
       'overflow-y': this.$store.getters.logs.length > 8 ? 'scroll' : 'hidden'
       }" >
        <md-layout
...
export default {
  ...
  methods: {
    ...
    // this.selectedDelDateIn(new_date)
