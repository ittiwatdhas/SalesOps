<template>
  <div
    ...
    :style="{'top': option.top+100 +'px','left': '80%','position':'absolute','z-index':'1000'}"
  ...
  >
    ...
    <div class="footer" style="background: #ffffff; padding-left: 60%;">
      <md-button @click="onClose()" style="color: #a8a8a8;">close</md-button>
    </div>
  </div>
</template>
<script>
